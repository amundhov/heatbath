...
# Generated by qmake (2.01a) (Qt 4.8.1) on: ons. mai 9 16:35:55 2012
# Project:  src.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/share/qt/mkspecs/linux-g++ CONFIG+=debug CONFIG+=declarative_debug -o Makefile src.pro
#############################################################################
...
CXXFLAGS      = -pipe -g3 -g -Wall -W $(DEFINES)
...
Makefile: src.pro  /usr/share/qt/mkspecs/linux-g++/qmake.conf /usr/share/qt/mkspecs/common/unix.conf \
		...
		/usr/share/qt/mkspecs/features/lex.prf \
		/usr/share/qt/mkspecs/features/include_source_dir.prf
	$(QMAKE) -spec /usr/share/qt/mkspecs/linux-g++ CONFIG+=debug CONFIG+=declarative_debug -o Makefile src.pro
